...
class Twig_Tests_ErrorTest extends PHPUnit_Framework_TestCase {
	public function testErrorWithObjectFilename() {
		...
		$this->assertContains( 'test' . DIRECTORY_SEPARATOR . 'Twig' . DIRECTORY_SEPARATOR . 'Tests' .
		                       DIRECTORY_SEPARATOR . 'ErrorTest.php',
		                       $error->getMessage() );
	}
	...
	public function testTwigExceptionAddsFileAndLineWhenMissingWithInheritanceOnDisk() {
		...
		$twig   = new Twig_Environment( $loader,
		                                array( 'strict_variables' => TRUE, 'debug' => TRUE, 'cache' => FALSE ) );
