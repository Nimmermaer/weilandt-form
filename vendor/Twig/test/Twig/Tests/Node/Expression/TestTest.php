...
class Twig_Tests_Node_Expression_TestTest extends Twig_Test_NodeTestCase {
	...
	public function getTests() {
		...
		$environment->addTest( new Twig_SimpleTest( 'barbar',
		                                            'twig_tests_test_barbar',
		                                            array( 'is_variadic' => TRUE, 'need_context' => TRUE ) ) );
		...
		if ( PHP_VERSION_ID >= 50300 ) {
			$node    = $this->createTest( new Twig_Node_Expression_Constant( 'foo', 1 ),
			                              'anonymous',
